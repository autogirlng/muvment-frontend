...
type Props = {
  ...
  onTabChange?: (value: string) => void; // Add this prop
  defaultValue?: string; // Add this prop for fallback
};
...
const AppTabs = ({
  ...
  <Tabs.Root
    className="w-full"
    value={activeTab} // Use controlled value if provided
    defaultValue={activeTab || defaultValue} // Fallback to defaultValue
    onValueChange={onTabChange} // Handle tab changes
  >
    <Tabs.List
