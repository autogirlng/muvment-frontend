  ...
  return (
    <section className="relative bg-hero-image bg-cover bg-center bg-no-repeat min-h-full md:min-h-screen h-auto md:h-[880px] pt-[35px] pb-6 md:pb-10">
      ...
      <div className="container h-[calc(100%-100px)] flex items-center z-10">
        <div className="space-y-3 md:space-y-6 text-white text-center md:text-left max-w-[992px] mx-auto md:mx-0">
      ...
      <div className="container h-10 md:h-20 text-white !mt-8 md:!mt-0">
        <div className="absolute left-0 md:left-4 top-0 flex items-center justify-center md:justify-start gap-1 w-full md:w-fit">
          ...
          <div className="text-xl md:text-4xl 3xl:text-h2 !font-bold">
