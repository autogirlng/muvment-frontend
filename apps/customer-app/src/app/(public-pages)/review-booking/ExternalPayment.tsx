...
const Carousel: FC<{ vehicleImages: string[] }> = ({ vehicleImages }) => {
  ...
  const goToPrevious = () => {
    setCurrentIndex(
      (prevIndex) =>
        (prevIndex - 1 + vehicleImages.length) % vehicleImages.length
    );
  };
  ...
  return (
    <>
      {vehicleImages.length > 0 ? (
        <>
          <div
            className="relative mb-4 flex justify-center items-center overflow-hidden rounded-2xl"
            style={{ height: "400px" }}
          >
            <Image
        ...
        <div
          className="relative mb-4 flex justify-center items-center overflow-hidden rounded-2xl bg-gray-200"
          style={{ height: "400px" }}
        >
...
export default function ExternalBookingLinkPage() {
  ...
  const fetchBookingDetails = async () => {
    ...
    try {
      const bookingDetails = await http.get<Booking>(
        `/api/bookings/getSingle/${bookingId}`
      );
      const images = [
      ...
      <div className="max-w-lg mx-auto px-4  bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
        ...
        <div className=" py-4 ">
          ...
          <div className=" flex flex-col mt-4 gap-4 shadow-sm">
            ...
            <div className=" rounded-lg">
              ...
              <div>
                {booking?.outskirtsLocation.map((location, index) => {
                  return (
                    <span className="text-sm text-[#667185]" key={index}>
                      {location + " "}
                    </span>
                  );
                })}
        ...
        <div className=" py-4 ">
          <h2 className="text-lg font-semibold">
            Vehicle - {booking?.vehicle.listingName}{" "}
          </h2>
          ...
          <div className=" flex flex-col mt-4 gap-4 shadow-sm">
            <div className=" rounded-lg">
              ...
              <div className="text-sm text-[#667185]">
                {booking?.vehicle.vehicleColor}
              </div>
            </div>
            <div className=" rounded-lg">
              <div className="text-xs  font-bold mb-1">Number of Seats</div>
              <div className="text-sm text-[#667185]">
                {booking?.vehicle.numberOfSeats}
              </div>
            </div>
            <div className="rounded-lg">
              ...
              <div className="flex flex-row gap-x-2">
                {booking?.vehicle.features.map((feature, index) => {
                  return (
                    <span key={index} className="text-sm text-[#667185] ">
                      {feature}
                    </span>
                  );
                })}
        ...
        {booking?.extraDetails.length !== 0 ||
          (booking?.purposeOfRide.length !== 0 && (
            <div className=" py-4 ">
              ...
              <div className=" flex flex-col mt-4 gap-4 shadow-sm">
                ...
                {booking.purposeOfRide && (
                  <div className="rounded-lg">
                    ...
                    <div className="text-sm text-[#6671s85] ">
                      {booking.purposeOfRide}
                    </div>
                  </div>
                )}
        ...
        <div className=" py-4 ">
          ...
          <div className=" flex flex-row mt-4 gap-4 shadow-sm">
            ...
            <div className="rounded-lg">
              ...
              <div className="text-sm text-[#667185]">
                ₦{booking?.vehicle.pricing.extraHoursFee}
              </div>
            </div>
          </div>
          <div className=" rounded-lg">
