...
import AvailabilityAndPricingForm from "@/components/VehicleOnboarding/AvailabilityAndPricing/AvailabilityAndPricingForm";
    ...
    <main className="pb-[188px] pt-[52px] md:pt-16 px-8 lg:px-[52px] min-h-screen">
      <div className="max-w-[1492px] mx-auto space-y-8 md:space-y-[52px]">
        <div className="space-y-8">
          ...
          <h2 className="text-h5 md:text-4xl text-black">Vehicle Onboarding</h2>
        </div>
